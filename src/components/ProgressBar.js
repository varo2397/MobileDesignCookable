...
class ProgressBar extends Component {
    render() {
        const { isMobile, instructionsText, instructionsTitle, instructionsStep, showNavigation, isPortrait } = this.props;
        return (
            <Fragment>
                {
                        ...
                        showNavigation || isPortrait ?
                            <div className="d-flex flex-row w-100 pb-4" >
                                ...
                                <div className="d-flex flex-column pr-2" style={{ width: '20%' }}>
                                    ...
                                    <p className="text-white align-self-center progress-text" style={{ marginBottom: isPortrait && isMobile ? -2 : '' }}><i
                                        className="fas fa-chevron-double-down current-step-icon-details"></i></p>
                                    <div className="d-flex flex-row">
                                        <div className="progress-default progress-process"></div>
                                        <div className="progress-missing"></div>
...
export default withPortrait(withMobile(ProgressBar));